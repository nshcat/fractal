		...
		namespace internal
		{
			...
			class shader final
			{
				...
				public:
					...
					shader(from_text_t, ut::string_view p_text)
						: shader()
					{
					...
					shader(from_file_t, ut::string_view p_path)
						: shader()
					{
				...
				public:
					auto source(from_file_t, ut::string_view p_path)
						-> void
					{
					...
					auto source(from_text_t, ut::string_view p_text)
						-> void
					{
